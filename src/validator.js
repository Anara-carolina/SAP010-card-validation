...
enviarBtn.addEventListener("click", function(event) {
  ...
  const maskedNumber = '**** **** **** ' + valueInput.slice(-4);
  ...
  if (valueInput === '') {
    ...
    alert('Número de cartão válido ' + maskedNumber); // Se o cartão de crédito for válido, exibe uma mensagem de sucesso com o número do cartão mascarado
  } else {
